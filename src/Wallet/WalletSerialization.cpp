...
std::string encrypt(const std::string& plain, CryptoNote::CryptoContext& cryptoContext) {
  ...
  Crypto::chacha8(plain.data(), plain.size(), &cryptoContext.key.data[0], &cryptoContext.iv.data[0], &cipher[0]);
...
std::string decrypt(const std::string& cipher, CryptoNote::CryptoContext& cryptoContext) {
  ...
  Crypto::chacha8(cipher.data(), cipher.size(), &cryptoContext.key.data[0], &cryptoContext.iv.data[0], &plain[0]);
  return plain;
}
